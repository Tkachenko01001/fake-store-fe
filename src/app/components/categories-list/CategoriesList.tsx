...
const CategoriesList = () => {
    ...
    return (
        <ul className="flex flex-col justify-around gap-y-10">
            <li className={`p-4 rounded-lg cursor-pointer ${selectedCategory === 'all' ? 'bg-blue-500 text-white shadow-md' : 'bg-gray-200 text-gray-700 hover:bg-gray-300 transition duration-300'}`}
                onClick={(e) => handleClickForCategory(e, 'all')}>
